				...
				<div className='container'>
					<Row>
						...
						<Col md={6} sm={8} xs={24}>
							...
							Krungthai โทร.<a className="ml-1" href="tel:021111144"><span className="nowrap">0 2111 1144</span></a>
							</div>
						</Col>
						<Col md={6} sm={8} xs={24}>
						<div className='head'>ข้อมูลลงทะเบียนผู้ประกอบการ</div>
						<div className='detail'>เงื่อนไขและวิธีการเข้าร่วมมาตรการฯ</div>
						<div className='detail'>ติดต่อ โทร.<a className="ml-1" href="tel:022706400"><span className="nowrap">0 2270 6400 กด 7</span></a>
					</div>
						</Col>
						<Col md={6} sm={8} xs={24}>
